...
//    }
    ...
    public static String getTime(Context context, long timestamp) {
        ...
        SimpleDateFormat format = new SimpleDateFormat(context.getString(R.string.time_format_hours),
                Locale.CHINA);
        SimpleDateFormat format1 = new SimpleDateFormat(context.getString(R.string.time_format_accuracy),
                Locale.CHINA);
        String date = format.format(timestamp);
        ...
        if (date1.getDate() - date2.getDate() == 0) {
            ...
            return date2.getMonth() + 1 + context.getString(R.string.month) + date2.getDate()
