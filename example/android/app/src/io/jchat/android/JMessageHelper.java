...
public class JMessageHelper extends ReactContextBaseJavaModule implements ActivityEventListener {
        ...
        if (activity != null) {
            try {
                if (FileHelper.isSdCardExist()) {
                    ...
                    activity.startActivityForResult(intent, MainApplication.REQUEST_CODE_TAKE_PHOTO);
                } else {
    ...
    public void selectImageFromLocal() {
        ...
        if (activity != null) {
            try {
                ...
                activity.startActivityForResult(intent, MainApplication.REQUEST_CODE_SELECT_PICTURE);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    public void onActivityResult(final Activity activity, int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == MainApplication.REQUEST_CODE_TAKE_PHOTO) {
...
//                mUri = Uri.fromFile(new File(mPath));
        ...
        } else if (requestCode == MainApplication.REQUEST_CODE_SELECT_PICTURE) {
            if (data != null) {
