...
import SendTextCell from '../components/send_text_cell';
import ReceiveTextCell from '../components/receive_text_cell';
...
export default class ChatActivity extends React.Component {
	...
	componentWillUnmount() {
		...
		DeviceEventEmitter.removeListener(SEND_MSG_RESULT);
		JMessageModule.resetUnreadMsgCnt(this.props.username, this.props.appKey, this.props.groupId);
